// Arrays are a useful data structure in JavaScript. They allow you to store a collection of data in a single variable. Arrays are created using square brackets, like this:
var myArray = [1, 2, 3];
